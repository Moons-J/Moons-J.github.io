...
const PersonalCard = (props) => {
  ...
  return (
    <div className='personal-card basic-card' style={{ maxWidth: [window.innerWidth < 519 ? '380px' : (window.innerWidth > 992 ? '380px' : '232px')] }}>
      ...
      <button className="disabled">download my cv here.</button>
